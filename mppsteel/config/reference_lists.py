...
DATA_OBJECTS = {
    ...
    "intermediate_data": [
        ...
        "regional_steel_demand_formatted",
        "tco_summary_data",
        "tech_choice_dict",
        "tech_choice_records",
        "tech_rank_records",
