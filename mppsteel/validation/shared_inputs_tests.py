...
from mppsteel.model_config import PKL_DATA_IMPORTS, PE_MODEL_SHEETNAME_DICT
...
CCUS_TRANSPORT_SCHEMA = DataFrameSchema({
    ...
    'Transport Type': Column(str, Check.isin(['Onshore Pipeline', 'Offshore Pipeline', 'Shipping'])),
...
CCUS_STORAGE_FACTOR = DataFrameSchema({
    ...
    'Storage type': Column(str, Check.isin(['Depleted O&G field', 'Saline aquifers'])),
