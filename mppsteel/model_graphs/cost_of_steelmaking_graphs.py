...
def get_lcost_lowest_vals(
    ...
    """Gets the lowest regional Levelised Cost values for a specified year.
...
def lcost_graph(
    ...
    fig_ = bar_chart(
        ...
        yaxis_title="Levelised Cost [$/tCS]",
        title_text=f"Levelised cost by end-state compatible technology in {chosen_year}",
    )
