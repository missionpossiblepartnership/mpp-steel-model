...
TECHNOLOGY_PROCESSES = {
    ...
    'Limestone',
    'Self-Generation Of Electricity'],
    'BAT BF-BOF_bio PCI': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Blast Furnace',
    'Oxygen Generation',
    ...
    'Limestone',
    'Self-Generation Of Electricity'],
    'BAT BF-BOF_H2 PCI': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Blast Furnace',
    'Oxygen Generation',
    ...
    'Limestone',
    'Self-Generation Of Electricity'],
    'BAT BF-BOF+CCUS': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Blast Furnace',
    'Oxygen Generation',
    ...
    'Self-Generation Of Electricity',
    'CCS'],
    'DRI-EAF': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Shaft Furnace',
    'EAF (Steel-making) + Casting'],
    'DRI-EAF_50% green H2': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Shaft Furnace',
    'EAF (Steel-making) + Casting'],
    'DRI-EAF_50% bio-CH4': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Shaft Furnace',
    'EAF (Steel-making) + Casting'],
    'DRI-EAF+CCUS': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Shaft Furnace',
    'EAF (Steel-making) + Casting',
    'CCS'],
    'DRI-EAF_100% green H2': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Shaft Furnace',
    'EAF (Steel-making) + Casting'],
    'Smelting Reduction': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Smelting Furnace',
    'Oxygen Generation',
    ...
    'Basic Oxygen Steelmaking + Casting',
    'Self-Generation Of Electricity'],
    'Smelting Reduction+CCUS': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Smelting Furnace',
    'Oxygen Generation',
    ...
    'Blast Furnace',
    'EAF (Steel-making) + Casting'],
    'Electrolyzer-EAF': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Electrolyzer',
    'EAF (Steel-making) + Casting'],
    'BAT BF-BOF+CCU': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Blast Furnace',
    'Oxygen Generation',
    ...
    'Limestone',
    'Basic Oxygen Steelmaking + Casting'],
    'DRI-Melt-BOF+CCUS': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Shaft Furnace',
    'Remelt',
    ...
    'Basic Oxygen Steelmaking + Casting',
    'CCS'],
    'DRI-Melt-BOF_100% zero-C H2': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Shaft Furnace',
    'Remelt',
    ...
    'Limestone',
    'Basic Oxygen Steelmaking + Casting'],
    'Electrowinning-EAF': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Electrolyzer',
    'EAF (Steel-making) + Casting'],
    'BAT BF-BOF+BECCUS': ['Coke Production',
    'Sintering',
    'Pelletisation',
    'Blast Furnace',
    'Oxygen Generation',
