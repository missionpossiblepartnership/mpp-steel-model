...
def generic_summary(
    ...
    value_cols: list, custom_agg_function: Callable = None,
):
    total_runs = df["total_runs"].unique()[0]
...
def summarise_combined_data(df: pd.DataFrame, results_dict: dict, filename: str = "") -> pd.DataFrame:
    ...
    if filename == "production_emissions":
        ...
        results_dict["production_resource_usage_summary"] = production_resource_usage_summary
        results_dict["plant_capacity_summary"] = plant_capacity_summary
        results_dict["plant_capacity_summary_country_breakdown"] = plant_capacity_summary_country_breakdown
        ...
        results_dict["levelized_cost_standardized_summary"] = levelized_cost_standardized_summary
        ...
        results_dict["calculated_emissivity_combined_summary"] = calculated_emissivity_combined_summary
