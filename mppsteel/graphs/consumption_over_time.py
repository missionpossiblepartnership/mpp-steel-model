...
def format_cot_graph(df: pd.DataFrame, regions: list = None, resource_list: list = None):
...
def consumption_over_time_graph(regions: list = None, save_filepath:str=None, ext:str='png'):
